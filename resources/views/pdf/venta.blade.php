...
@foreach($venta as $v)
    <header>
        ...
        <div id="datos">
            <p id="encabezado">
                <b>Upanel</b><br>Andrés Felipe Cardozo Cañas, Cali, Colombia<br>Telefono:(+57)3178876494<br>Email: andres.cardozo96@gmail.com
            </p>
        </div>
        <div id="fact">
            ...
            <table id="facarticulo">
                ...
                @foreach($venta as $v)
                    <tr>
                        ...
                        <th></th>
                        <th>SUBTOTAL</th>
                        <td>$ {{round(($v->total - (($v->total * ($v->impuesto / 100)))), 2)}}</td>
                    </tr>
                    <tr>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th>Impuesto</th>
                        <td>$ {{round($v->total * ($v->impuesto / 100), 2)}}</td>
                    </tr>
                    <tr>
                        <th></th>
                        <th></th>
