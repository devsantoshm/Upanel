                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <button @click="listarRol(1, buscar, criterio)" type="submit" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
...
<script>
    export default {
        ...
        mounted() {
            this.listarRol(1, this.buscar, this.criteria);
        }
    }
</script>
<style>
