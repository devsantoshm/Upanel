    ...
    export default {
        ...
        computed:{
            ...
            calcularTotal: function(){
                ...
                for(let i=0; i<this.arrayDetalle.length; i++) {
                    resultado += ((this.arrayDetalle[i].precio * this.arrayDetalle[i].cantidad) - ((this.arrayDetalle[i].precio * this.arrayDetalle[i].cantidad) * (this.impuesto / 100))) + (this.arrayDetalle[i].precio * this.arrayDetalle[i].cantidad * (this.impuesto / 100))
                }
                return resultado;
            },
            ...
            calcularTotalImpuesto: function(){
                ...
                for(let i=0; i<this.arrayDetalle.length; i++){
                    resultado += (this.arrayDetalle[i].precio * this.arrayDetalle[i].cantidad * (this.impuesto / 100))
                }
                return resultado;
            },
            ...
            calcularTotalParcial: function(){
                ...
                for(let i=0; i<this.arrayDetalle.length; i++){
                    resultado += ((this.arrayDetalle[i].precio * this.arrayDetalle[i].cantidad) - ((this.arrayDetalle[i].precio * this.arrayDetalle[i].cantidad) * (this.impuesto / 100)))
                }
                return resultado;
            },
        },
        methods : {
            listarIngreso (page,buscar,criterio){
                let me=this;
                let url= '/ingreso?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            buscarArticulo() {
                ...
                axios.get(url).then(function (response) {
                   ...
                   if (me.arrayArticulo.length > 0) {
                       ...
                       me.articulo = 'No exíste un articulo que coincida.';
                       me.idarticulo = 0;
                   }
                })
                    .catch(function (error) {
            ...
            verIngreso(id) {
                ...
                let arrayIngresoT = [];
                let url = '/ingreso/obtenerCabecera?id=' + id;
                ...
                let urld = '/ingreso/obtenerDetalles?id=' + id;
            ...
            abrirModal(){
                this.arrayArticulo = [];
                this.modal = 1;
                this.tituloModal = 'Seleccione artículos';
            },
